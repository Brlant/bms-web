        ...
        <div :class="[{'active':currentItemId===item.projectId}]"
          ...
          <el-row>
            ...
            <el-col :span="4" class="opera-btn">
              ...
              <des-btn @click="start(item)" icon="start" v-has="'enable-project'" v-show="item.projectState === '0'">启用</des-btn>
              <des-btn @click="stop(item)" icon="stop" v-has="'enable-project'" v-show="item.projectState === '1'">停用</des-btn>
            </el-col>
          </el-row>
        </div>
      </div>
